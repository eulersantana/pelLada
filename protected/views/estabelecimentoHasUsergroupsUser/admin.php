...
$('.search-form form').submit(function(){
	$('#estabelecimento-has-usergroups-user-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Estabelecimento Has Usergroups Users</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'estabelecimento-has-usergroups-user-grid',
